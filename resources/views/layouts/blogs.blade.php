                ...
                <div class="modal-content" style="padding: 20px">
                    <div class="wpb_wrapper">
                        <h2 style="text-align: center;"><span
                                style="color: #000;">{{ __('Start your journey with us now') }}</span></h2>
                    ...
                    <div class="container" style="width: 100%">
                        ...
                        <form id="SubmitFormnew" style="color: black">
                            <div class="mb-3">
                                ...
                                <input type="text" style="height: 50px;font-size: 18px;" class="form-control"
                                    id="compname">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" style="height: 50px;font-size: 18px;" class="form-control"
                                    id="InputEmailnew">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" style="height: 50px;font-size: 18px;" class="form-control"
                                    id="InputMobilenew">

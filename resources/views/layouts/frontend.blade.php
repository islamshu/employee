            ...
            <div class="container">
                <div class="top-area-items inline-inside">
                    ...
                    <div class="top-area-block top-area-socials socials-colored-hover" style="margin-right: 50%">
                        <div class="socials inline-inside">
                            <a class="socials-item"><img src="{{ get_flag($country) }}" width="60"
                                    height="30" alt=""></i></a>
                        </div>
                    </div>
                                                ...
                                                <div class="controls-top" style="text-align: center">
                                                    <a class="black-text" href="#multi-item-example"
                                                        data-slide="prev"><img
                                                            ...
                                                            height="40" alt=""></a>
                                                    <a class="black-text" href="#multi-item-example"
                                                        data-slide="next"><img src="{{ asset('uploads/left.webp') }}"
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 stats">
                                                            <i class="{{ $statistic->icon1 }}"
                                                                aria-hidden="true"></i>
                                                            <div class="counting"
                                                                data-count="{{ $statistic->number1 }}">0</div>
                                                            <h5>{{ $statistic->title1 }}</h5>
                                                        </div>

                                                        <div class="col-lg-3 stats">
                                                            <i class="{{ $statistic->icon2 }}"
                                                                aria-hidden="true"></i>
                                                            <div class="counting"
                                                                data-count="{{ $statistic->number2 }}">0</div>
                                                            <h5>{{ $statistic->title2 }}</h5>
                                                        </div>

                                                        <div class="col-lg-3 stats">
                                                            <i class="{{ $statistic->icon3 }}"
                                                                aria-hidden="true"></i>
                                                            <div class="counting"
                                                                data-count="{{ $statistic->number3 }}">0</div>
                                                            <h5>{{ $statistic->title3 }}</h5>
                                                        </div>

                                                        <div class="col-lg-3 stats">
                                                            <i class="{{ $statistic->icon4 }}"
                                                                aria-hidden="true"></i>
                                                            <div class="counting"
                                                                data-count="{{ $statistic->number4 }}">0</div>
                        ...
                        <div class="col-lg-4 col-md-12 mb-4">
                            <div class="card">
                                <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                    <img src="{{ asset('uploads/' . $item->image) }}" class="img-fluid" width="100"
                                        height="100" />
                                    <a href="#!">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">
                                        {{ \Illuminate\Support\Str::words($item->title, 10, '...') }}</h5>
                                    <p class="card-text">
                                        {!! \Illuminate\Support\Str::words($item->description, 20, '...') !!}
                                    </p>
                                    <a href="{{ route('blog', $item->slug) }}"
                                        class="btn btn-primary">{{ __('Read') }}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach

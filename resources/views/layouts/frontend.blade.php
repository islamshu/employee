...
<head>
    ...
    <!--[if lt IE 9]>
<script type='text/javascript' src='https://foryou.com/wp_content/themes/thegem/js/html5.js?ver=3.7.3' id='html5-js'>
</script>
<![endif]-->
    <meta name="generator"
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed78b2.json?url=https%3A%2F%2Fforyou.com%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embedf6e2?url=https%3A%2F%2Fforyou.com%2F&amp;format=xml" />
    ...
    <style type="text/css" data-type="vc_shortcodes-custom-css">
        .vc_custom_1602619660157 {
            ...
            @if (get_lang() == 'en')transform: scaleX(-1);
            @endifbackground-position: center !important;
                ...
                <div class="top-area-items inline-inside">
                    <div class="top-area-block top-area-socials socials-colored-hover">
                        <div class="socials inline-inside">
                            ...
                            @if (get_general_value('facebook') != null)
                                <a class="socials-item" href="{{ get_general_value('facebook') }}"
                                    target="_blank" title="facebook"><i class="socials-item-icon facebook "></i></a>
                            @endif
                            @if (get_lang() == 'ar')
                    ...
                    <div class="top-area-block top-area-socials socials-colored-hover" style="margin-right: 50%">
                        <div class="socials inline-inside">
                            ...
                            <a class="socials-item"><img
                                    src="http://website.foryougo.net/pragmarx/countries/flag/file/{{ $country->cca3 }}.svg"
                                    width="60" height="30" alt=""></i></a>
                                ...
                                <div class="site-logo" style="width:180px;">
                                    <a href="/" rel="home">
                                        <span class="logo"><img
                                                ...
                                                data-tgpli-srcset="{{ asset('uploads/' . get_general_value('header_logo')) }} 1x,https://foryou.com/wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_2x.png 2x,https://foryou.com/wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_3x.png 3x"
                                                alt="فوريو" style="width:180px;" class="default" data-tgpli-inited
                                            ...
                                            <img src="wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_1x.png"
                                                srcset="{{ asset('uploads/' . get_general_value('header_logo')) }} 1x,https://foryou.com/wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_2x.png 2x,https://foryou.com/wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_3x.png 3x"
                                                alt="فوريو" style="width:180px;" class="default" /></noscript><img
                                                data-tgpli-src="{{ asset('uploads/' . get_general_value('header_logo')) }}"
                                                data-tgpli-srcset="{{ asset('uploads/' . get_general_value('header_logo')) }} 1x,https://foryou.com/wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_2x.png 2x,https://foryou.com/wp_content/uploads/thegem-logos/logo_8c4676c76b0e25450e8e77c212e4cbee_3x.png 3x"
                                                alt="فوريو" style="width:100px;" class="small" data-tgpli-inited
                            ...
                            <nav id="primary-navigation" class="site-navigation primary-navigation"
                                ...
                                <ul id="primary-menu" class="nav-menu styled no-responsive dl-menu">
                                    ...
                                    <li id="menu-item-1451"
                                        ...
                                        <a href="#vc_row-62986ef229645">{{ __('Home') }} </a><span
                                            class="menu-item-parent-toggle"></span>

                                    </li>
                                    <li id="menu-item-1451"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-parent menu-item-1451 megamenu-first-element">
                                        <a href="#vc_row-62986ef22f13e">{{ __('Partners') }}</a><span
                                            class="menu-item-parent-toggle"></span>

                                    </li>
                                    <li id="menu-item-1451"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-parent menu-item-1451 megamenu-first-element">
                                        <a href="#programs">{{ __('Our programs') }}</a><span
                                            class="menu-item-parent-toggle"></span>

                                    </li>
                                    <li id="menu-item-1451"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-parent menu-item-1451 megamenu-first-element">
                                        <a href={{ route('contact_us') }}>{{ __('contact us') }}</a><span
                                            class="menu-item-parent-toggle"></span>
                            ...
                            <div class="panel-center col-xs-12">
                                <article id="post-1016" class="post-1016 page type-page status-publish">
                                    ...
                                    <div class="entry-content post-content">
                                        ...
                                        <div id="vc_row-62986ef229645" data-vc-full-width="true"
                                            data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid vc_custom_1602619660157 vc_row-has-fill vc_row-o-full-height vc_row-o-columns-middle thegem-fix-full-height vc_row-o-content-top vc_row-flex">
                                            <script type="text/javascript">
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12"
                                                @if (get_lang() == 'en') style="    transform: scaleX(-1);"
                                                @else
                                                style="    text-align: right;" @endif>
                                                <div class="vc_column-inner vc_custom_1601299991278">
                                                    <div class="wpb_wrapper">
                                                        <div
                                                            class="wpb_text_column wpb_content_element  vc_custom_1601488817120">
                                                            <div class="wpb_wrapper">
                                                                <div class="title-h1">
                                                                    {!! $first_se->main_title !!}
                                                                </div>
                                                        ...
                                                        <div
                                                            class="wpb_text_column wpb_content_element  vc_custom_1601208748564">
                                                            <div class="wpb_wrapper">
                                                                        ...
                                                                        <div class="gem-alert-box centered-box">
                                                                            <div class="gem-alert-inner">
                                                                                ...
                                                                                <div class="gem-alert-box-buttons">
                                                                                    <div
                                                                                        class="gem-button-container gem-button-position-inline">
                                                                                        <a class="gem-button gem-button-size-medium gem-button-style-flat gem-button-text-weight-normal"
                                                                                            style="border-radius: 36px;background-color: #de4f76;color: #ffffff;"
                                                                                            onmouseleave="this.style.backgroundColor='#de4f76';this.style.color='#ffffff';"
                                                                                            onmouseenter="this.style.backgroundColor='#de4f76';this.style.color='#ffffff';"
                                                                                            href="{{ $first_se->first_link }}"
                                                                                            target="_self">{{ $first_se->first_btn }}</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        @if ($first_se->secand_btn != null && $first_se->secand_link != null)
                                                            <div class="wpb_raw_code wpb_content_element wpb_raw_html"
                                                                ...
                                                                <div class="wpb_wrapper">
                                                                    <span
                                                                        class="wistia_embed wistia_async_1w9lj1e9sb popover=true popoverContent=link"
                                                                        ...
                                                                        <a style="border-radius: 36px !important;
                                                                            ...
                                                                            top: -70px !important;
                                                                            right: 155px ;"
                                                                            href="{{ $first_se->secand_link }}">{{ $first_se->secand_btn }}
                                                                        </a>
                                                                    </span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="vc_row-full-width-before"></div>
                                        <div style="display: none" id="vc_row-62986ef231b7c"
                                            data-vc-full-width="true" data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid z-index wpb_animate_when_almost_visible wpb_fadeInRight fadeInRight vc_custom_1600125432050 vc_row-has-fill">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                        ...
                                        <div class="vc_row-full-width-before"></div>
                                        <div id="vc_row-62986ef232c56" data-vc-full-width="true"
                                            data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid vc_custom_1600777159542 vc_row-has-fill">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                            ...
                                            <div
                                                class="why-block wpb_column vc_column_container vc_col-sm-12 vc_col-md-8">
                                                <div class="vc_column-inner ">
                                                    <div class="wpb_wrapper">
                                                        <div class="clearboth"></div>
                                                        <div class="gem-divider " style="margin-top: 45px;"></div>
                                                        <div
                                                            class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bottom-to-top bottom-to-top vc_custom_1600771884224">
                                                            <div class="wpb_wrapper">
                                            ...
                                            <div
                                                class="wpb_column vc_column_container vc_col-sm-12 vc_col-md-4 disable-custom-paggings-tablet disable-custom-paggings-mobile">
                                                <div class="vc_column-inner vc_custom_1586524780725">
                                                    <div class="wpb_wrapper">
                                                        @foreach ($third->relation as $item)
                                                            <div
                                                                class="gem-icon-with-text gem-icon-with-text-icon-size-medium gem-icon-with-text-flow">
                                                                <div style="margin-bottom:0px;margin-top:0px; "
                                                                    class="gem-icon-with-text-icon">
                                                                    <div class="gem-icon gem-icon-pack-material gem-icon-size-medium  gem-icon-shape-square gem-simple-icon"
                                                                        style="opacity: 1;">
                                                                        <div class="gem-icon-inner" style="">
                                                                            <span class="gem-icon-half-1"
                                                                                style="color: #ffffff;">
                                                                                <span
                                                                                    class="back-angle">{!! $item->icon !!}</span></span>
                                                                ...
                                                                <div class="gem-icon-with-text-content">
                                                                    <div class="gem-icon-with-text-text">
                                                                        <div
                                                                            class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bottom-to-top bottom-to-top">
                                                                            <div class="wpb_wrapper">
                                                                                <h6 style="font-family: system-ui">
                                                                                    <span
                                                                                        style="color: #ffffff;">{{ $item->title }}<br />
                                                                                    </span></h6>
                                        ...
                                        <div class="vc_row-full-width-before"></div>
                                        <div id="vc_row-62986ef23ee6f" data-vc-full-width="true"
                                            data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid vc_custom_16007207530002 vc_row-has-fill">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner ">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <div
                                                            class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bottom-to-top bottom-to-top vc_custom_1600767836328">
                                                            <div class="wpb_wrapper">
                                                                <h3 style="text-align: center;"><span
                                                                        style="color: #ffffff;">{{ __('Join now and get a trial period') }}</span>
                                                                </h3>
                                                        ...
                                                        <div id="i-want-button"
                                                            class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1587451772836">
                                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                                <div class="vc_column-inner ">
                                                                    <div class="wpb_wrapper">
                                                                        <div
                                                                            class="gem-button-container gem-button-position-center button-padings lazy-loading">
                                                                            <a class="gem-button gem-button-size-large gem-button-style-flat gem-button-text-weight-normal lazy-loading-item"
                                                                                data-ll-effect="drop-right-without-wrap"
                                                                                style="border-radius: 50px;background-color: #ffffff;color: #171b2d;"
                                                                                onmouseleave="this.style.backgroundColor='#ffffff';this.style.color='#171b2d';"
                                                                                onmouseenter="this.style.backgroundColor='#171b2d';this.style.color='#ffffff';"
                                                                                href="#"
                                                                                target="_blank">{{ __('Join now') }}
                                                                            </a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="vc_row-full-width vc_clearfix"></div>
                                        <div class="vc_row-full-width-before"></div>
                                        <div id="programs" data-vc-full-width="true" data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid custom-list-style vc_custom_1609826308527 vc_row-has-fill">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                            ...
                                            <div
                                                class="custom-list-style-begin wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner vc_custom_1586873359510">
                                                    <div class="wpb_wrapper">
                                                        <div
                                                            class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bottom-to-top bottom-to-top vc_custom_1600772395043">
                                                            <div class="wpb_wrapper">
                                                                <h2 class="any-custom-text"
                                                                    style="text-align: center;"><span
                                                                        style="color: #de4f76 ; forn size: 70px;">{{ __('Our programs') }}</span>
                                                                </h2>
                                                        ...
                                                        <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                                            @foreach ($programs as $pro)
                                                                <div
                                                                    class="custom-list-style-begin wpb_column vc_column_container vc_col-sm-6">
                                                                    <div class="vc_column-inner ">
                                                                        <div class="wpb_wrapper">
                                                                            @php
                                                                            ...
                                                                            <div
                                                                                class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bottom-to-top bottom-to-top begin-square">
                                                                                <div class="wpb_wrapper">
                                                                                    <h4 style="text-align: right;">
                                                                                        <span
                                                                                            style="color: #171b2d;">{{ __('Program') }}</span>
                                                                                    </h4>

                                                                                    <h1
                                                                                        style="margin-top: -27px; text-align: right;">
                                                                                        <span
                                                                                            style="color: #171b2d;">{{ $pro->title }}</span>
                                                                                    </h1>
                                                                            ...
                                                                            <div class="gem-list lazy-loading gem-list-type-check-style-1 gem-list-color-3"
                                                                                style="#bdcad1  !important">
                                                                                <ul>
                                                                            ...
                                                                            <div
                                                                                class="gem-button-container gem-button-position-right lazy-loading">
                                                                                <a title="{{ $pro->title }}"
                                                                                    class="gem-button gem-button-size-medium gem-button-style-flat gem-button-text-weight-normal lazy-loading-item"
                                                                                    data-ll-effect="drop-right-without-wrap"
                                                                                    style="border-radius: 50px;background-color: #bdcad1 ;color: #ffffff;"
                                                                                    onmouseleave="this.style.backgroundColor='#bdcad1 ';this.style.color='#ffffff';"
                                                                                    onmouseenter="this.style.backgroundColor='#bdcad1 ';this.style.color='#ffffff';"
                                                                                    href="{{ route('single_pro', $pro->id) }}"
                                                                                    target="_blank">{{ __('Learn about the program') }}</a>
                                                                            </div>
                                                                            <div class="clearboth"></div>
                                                                            <div class="gem-divider "
                                        ...
                                        <div style="width: 100%">
                                            ...
                                            <div id="multi-item-example"
                                                            ...
                                                            @foreach ($item as $chunk)
                                                                <div class="col-md-3 mb-3">
                                                                    <div class="card" style="border-radius: 20px;">
                                                                        <img class="img-fluid"
                                                                            src="http://foryougo.foryougo.net/images/brand/{{ $chunk->image }}"
                                                ...
                                                <div class="controls-top" style="text-align: center">
                                                    <a class="black-text" href="#multi-item-example"
                                                        data-slide="prev"><img
                                                            src="{{ asset('uploads/right.webp') }}" width="40"
                                                            height="40" alt=""></a>
                                                    <a class="black-text" href="#multi-item-example"
                                                        data-slide="next"><img
                                                            src="{{ asset('uploads/left.webp') }}" width="40"
                                                            height="40" alt=""></a>
                                                </div>
                                                <!--/.Slides-->
                                        ...
                                        <div class="vc_row-full-width vc_clearfix"></div>
                                        <div class="vc_row-full-width-before"></div>
                                        <div id="vc_row-62986ef239c0f" style="background:gainsboro"
                                            data-vc-full-width="true" data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid vc_custom_1601554316679 vc_row-o-content-middle vc_row-flex">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                            ...
                                            <div
                                                ...
                                                <div class="vc_column-inner vc_custom_1589911199704">
                                                    <div class="wpb_wrapper">
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <div class="title-h4"><span
                                                                        style="color: #2c2e3d;">{{ __('Figures and Statistics') }}</span>
                                                                </div>
                                                        ...
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <div class="title-xlarge" style="color: #69489D">
                                                                    {{ $statistic->main_title }}</div>
                                            ...
                                            <div
                                                class="counterdirection wpb_column vc_column_container vc_col-sm-12 vc_col-lg-offset-0 vc_col-lg-6 vc_col-md-offset-0 vc_col-md-6">
                                                <div class="vc_column-inner vc_custom_1601551755857">
                                                    <div class="wpb_wrapper">
                                                        <div class="clearboth"></div>
                                                        <div class="gem-divider " style="margin-top: 25px;"></div>
                                                        <div
                                                            class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1601550661897">
                                                            <div
                                                                class="wpb_column vc_column_container vc_col-sm-6 vc_col-has-fill">
                                                                <div class="vc_column-inner vc_custom_1601550931002">
                                                                    <div class="wpb_wrapper">
                                                                        <div data-number-format="(ddd).ddd"
                                                                            class="gem-counter-box row inline-row inline-row-center gem-counter-style-1 lazy-loading lazy-loading-not-hide">
                                                                            <div
                                                                                class="gem-counter col-xs-12 inline-column gem-counter-effect-border-reverse">
                                                                                <div class="gem-counter-inner">
                                                                                    <div class="gem-counter-icon">
                                                                                        <div class="gem-icon gem-icon-pack-material gem-icon-size-small  gem-icon-shape-circle"
                                                                                            style="border-color: #4ed2b3;opacity: 1;height: 60px;">
                                                                                            <div class="gem-icon-inner"
                                                                                                style=""><span
                                                                                                    class="gem-icon-half-1"
                                                                                                    style="color: #4ed2b3;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon1 !!};</span></span><span
                                                                                                    class="gem-icon-half-2"
                                                                                                    style="color: #4ed2b3;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon1 !!};</span></span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="gem-counter-number"
                                                                                        style="color: #3c3950">
                                                                                        <div class="gem-counter-odometer"
                                                                                            data-to="{{ $statistic->number1 }}">
                                                                                            0</div><span
                                                                                            class="gem-counter-suffix">+</span>
                                                                                    </div>
                                                                        ...
                                                                        <div data-number-format="(ddd).ddd"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="gem-counter-inner">
                                                                                    <div class="gem-counter-icon">
                                                                                        <div class="gem-icon gem-icon-pack-material gem-icon-size-small  gem-icon-shape-circle"
                                                                                            style="border-color: #00bcd4;opacity: 1;height: 60px;">
                                                                                            <div class="gem-icon-inner"
                                                                                                style=""><span
                                                                                                    class="gem-icon-half-1"
                                                                                                    style="color: #00bcd4;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon2 !!};</span></span><span
                                                                                                    class="gem-icon-half-2"
                                                                                                    style="color: #00bcd4;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon2 !!};</span></span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="gem-counter-number"
                                                                        ...
                                                                        <div data-number-format="(ddd).ddd"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="gem-counter-inner">
                                                                                    <div class="gem-counter-icon">
                                                                                        <div class="gem-icon gem-icon-pack-material gem-icon-size-small  gem-icon-shape-circle"
                                                                                            style="border-color: #8f6cff;opacity: 1;height: 60px;">
                                                                                            <div class="gem-icon-inner"
                                                                                                style=""><span
                                                                                                    class="gem-icon-half-1"
                                                                                                    style="color: #8f6cff;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon3 !!};</span></span><span
                                                                                                    class="gem-icon-half-2"
                                                                                                    style="color: #8f6cff;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon3 !!};</span></span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="gem-counter-number"
                                                                        ...
                                                                        <div data-number-format="(ddd).ddd"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="gem-counter-inner">
                                                                                    <div class="gem-counter-icon">
                                                                                        <div class="gem-icon gem-icon-pack-material gem-icon-size-small  gem-icon-shape-circle"
                                                                                            style="border-color: #3f99ff;opacity: 1;height: 60px;">
                                                                                            <div class="gem-icon-inner"
                                                                                                style=""><span
                                                                                                    class="gem-icon-half-1"
                                                                                                    style="color: #3f99ff;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon4 !!};</span></span>
                                                                                                <span
                                                                                                    class="gem-icon-half-2"
                                                                                                    style="color: #3f99ff;"><span
                                                                                                        class="back-angle">&#{!! $statistic->icon4 !!};</span></span>
                                        ...
                                        <div class="vc_row-full-width-before"></div>
                                        <div id="contact_us" data-vc-full-width="true"
                                            data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid vc_custom_1600720753000 vc_row-has-fill">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner ">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <div class="gem-divider " style="margin-top: 60px;"></div>
                                                        <div
                                                            class="wpb_text_column wpb_content_element  wpb_animate_when_almost_visible wpb_bottom-to-top bottom-to-top vc_custom_1600767829431">
                                                            <div class="wpb_wrapper">
                                                                <h2 style="text-align: center;"><span
                                                                        style="color: #ffffff;">{{ __('Start your journey with us now') }}</span>
                                                                </h2>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="wpb_wrapper">
                                                                <h3 style="text-align: center;"><span
                                                                        style="color: #ffffff;">{{ __('Join us now') }}</span>
                                                                </h3>
                                                        ...
                                                        <div class="container" style="width: 50%">
                                                            <div class="alert alert-success" role="alert"
                                                                id="successMsg" style="display: none">
                                                                {{ __('Thank you for joining us') }}
                                                            </div>
                                                            <form id="SubmitForm" style="color: white">
                                                                <div class="mb-3">
                                                                    <label for="compname"
                                                                        class="form-label">{{ __('Facility Name') }}</label>
                                                                    <input type="text"
                                                                        style="height: 50px;font-size: 18px;"
                                                                        class="form-control" id="compname">
                                                                    <span class="text-danger"
                                                                        id="COMPErrorMsg"></span>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="InputName"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        style="height: 50px;font-size: 18px;"
                                                                        class="form-control" id="co_register">
                                        ...
                                        <div id="vc_row-62986ef23ee6f" data-vc-full-width="true"
                                            data-vc-full-width-init="false"
                                            class="vc_row wpb_row vc_row-fluid vc_custom_16007207530001 vc_row-has-fill">
                                            <script type="text/javascript">
                                                if (typeof(gem_fix_fullwidth_position) == "function") {
                                                    gem_fix_fullwidth_position(document.getElementById("vc_row-62986ef23ee6f"));
                                                }

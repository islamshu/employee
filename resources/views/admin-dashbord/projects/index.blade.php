          ...
          <div class="card">
            ...
            <div class="card-content collapse show">
              <div class="card-body card-dashboard">
                ...
                <a href="{{ route('programs.create') }}" class="btn btn-info">انشاء جديد</a>
                <br>
                <br>
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('programs.edit',$project->id) }}" class="btn btn-icon btn-primary mr-1"> <i class="la la-edit"></i></a>
                        <form style="display: inline" action="{{ route('programs.destroy',$project->id) }}" method="post">
                        @csrf @method('delete')

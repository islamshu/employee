            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">تعديل مقال جديد
                        </li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control">تعديل مقال جديد  </h4>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="title_ar" class="form-control" required value="{{ $blog->getTranslation('title','ar') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label>العنوان   بالانجليزية * </label>
                                            <input type="text" name="title_en" class="form-control" required value="{{ $blog->getTranslation('title','en') }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>الوصف   بالعربية * </label>
                                            <textarea name="description_ar" required class="ckeditor" cols="30" rows="10">{{ $blog->getTranslation('description','ar') }}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label>الوصف   بالانجليزية * </label>
                                            <textarea name="description_en" required class="ckeditor" cols="30" rows="10">{{ $blog->getTranslation('description','en') }}</textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">

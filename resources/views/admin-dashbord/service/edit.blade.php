                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required value="{{ $service->title }}" id="userinput1"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required value="{{  $service->price }}" id="userinput1"
                                            ...
                                            <div class="form-group">
                                               ...
                                               <select name="type" id="select_servce" class="form-control">
                                                <option value="" selected disabled>اختر نوع الخدمة </option>
                                                   ...
                                                   <option value="duration" @if( $service->type =="duration") selected @endif>مدة </option>
                                                   <option value="qty"  @if( $service->type == "qty" ) selected @endif >كمية</option>

                                               </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6"  id="duration" @if( $service->type =="duration")  style="display: block" @else style="display: none" @endif>
                                            <div class="form-group">
                                                <label for="userinput1">المدة </label>
                                                <input type="text" value="{{ $service->duration }}" 
                                                    class="form-control border-primary" placeholder="المدة " id="id_duration" name="duration">
                                            </div>
                                        </div>
                                        <div class="col-md-6" id="qty"  @if( $service->type =="qty")  style="display: block" @else style="display: none" @endif>
                                            <div class="form-group">
                                                <label for="userinput1">الكمية </label>
                                                <input type="text"   value="{{ $service->qty }}" 
